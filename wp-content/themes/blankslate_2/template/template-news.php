				...
				<div class="image">
					<a href="<?php the_permalink()?>">
						...
						if (!empty($post_thumb_url)) {
							...
							$post_thumb_url = get_template_directory_uri().'/assets/images/news-thumb-default.png';
							echo '<img width="167" height="223" src="'.$post_thumb_url.'" class="attachment-medium size-medium wp-post-image" alt="">';
						}						
						?>
					</a>
				</div>
